...
--
-- 设计原则：
-- 1. 菜谱不写死 id，由 SERIAL 自动生成
-- 2. 关联表用 VALUES + JOIN recipes ON name + author_id 来引用菜谱
-- 3. 加新菜 = 在每张表的 VALUES 块末尾加一行

-- ====================================================================
-- 1. 用户（已存在则更新）
-- ====================================================================
INSERT INTO users (username, password_hash, display_name, email, phone, avatar_url, preferences_complete, role, status)
VALUES ('testuser', '$2a$10$AabeJArJr8/VkhmM9kWaxe4qc01p54NXg7QVAYYAVq7I136EVp1T6',
        '测试厨师', 'test@example.com', '138****1234', '', TRUE, 'super_admin', 'active')
...
-- ====================================================================
-- 2A. 菜谱（由 SERIAL 自动生成 id，已有则跳过）
-- ====================================================================
-- 注意：VALUES 第 2 列（author_id）为占位值（_unused_author_id，固定 NULL，不参与插入）；
-- 实际作者归属由下方子查询动态解析——testuser 的 id 不保证为 1
-- （注册/删除等操作会推进 SERIAL 序列），硬编码 1 会触发外键违约。
-- ====================================================================
INSERT INTO recipes (name, author_id, description, ingredients, instructions, steps,
                     prep_time_minutes, cook_time_minutes, servings,
                     tags, cooking_method, flavor, ingredient_type, status, nutrition_info)
SELECT v.name, (SELECT id FROM users WHERE username = 'testuser') AS author_id, v.description,
       v.ingredients::jsonb, v.instructions::text, v.steps::jsonb,
       v.prep_time_minutes, v.cook_time_minutes, v.servings,
       v.tags::text[], v.cooking_method, v.flavor, v.ingredient_type, v.status,
       v.nutrition_info::jsonb
FROM (VALUES
    ('番茄炒蛋', NULL, '经典家常菜',
     ...
     5, 10, 2, '{"中式","快手"}', '炒', '清淡', '荤', 'approved',
     '{"calories":350,"protein":15,"fat":20,"carbs":30,"per_serving":{"calories":350,"protein_g":15,"fat_g":20,"carbs_g":30,"fiber_g":2.5,"sodium_mg":480,"vitamin_c_mg":25},"ingredients_breakdown":[{"name":"鸡蛋","calories":140,"protein_g":12,"fat_g":10,"carbs_g":2},{"name":"番茄","calories":40,"protein_g":2,"fat_g":0.5,"carbs_g":8}],"health_notes":"本菜谱含钠量适中，高血压用户建议减少额外用盐。"}'::jsonb),
    ...
    ('清炒西兰花', NULL, '健康低脂',
     ...
     5, 8, 2, '{"低卡","素食"}', '炒', '清淡', '素', 'approved',
     '{"calories":120,"protein":8,"fat":2,"carbs":18,"per_serving":{"calories":120,"protein_g":8,"fat_g":2,"carbs_g":18,"fiber_g":6,"sodium_mg":200,"vitamin_c_mg":80},"ingredients_breakdown":[{"name":"西兰花","calories":55,"protein_g":4,"fat_g":0.5,"carbs_g":11},{"name":"蒜","calories":4,"protein_g":0.2,"fat_g":0,"carbs_g":1}],"health_notes":"低卡高纤维，适合减脂期食用。"}'::jsonb),
    ...
    ('鸡胸肉沙拉', NULL, '高蛋白轻食',
     ...
     15, 15, 1, '{"轻食","高蛋白"}', '拌', '清淡', '荤', 'approved',
     '{"calories":457.7,"protein":64.5,"fat":17.6,"carbs":7.4,"per_serving":{"calories":457.7,"protein_g":64.5,"fat_g":17.6,"carbs_g":7.4,"fiber_g":2.6,"sodium_mg":185.8,"vitamin_c_mg":38.1},"ingredients_breakdown":[{"name":"鸡胸肉","calories":330.0,"protein_g":62.0,"fat_g":7.2,"carbs_g":0},{"name":"生菜","calories":18.0,"protein_g":1.6,"fat_g":0.2,"carbs_g":2.4},{"name":"小番茄","calories":18.8,"protein_g":0.8,"fat_g":0.2,"carbs_g":4.4},{"name":"橄榄油","calories":88.4,"protein_g":0,"fat_g":10.0,"carbs_g":0},{"name":"黑胡椒","calories":2.5,"protein_g":0.1,"fat_g":0,"carbs_g":0.6}],"health_notes":"高蛋白轻食，适合健身人群。"}'::jsonb),
    ...
    ('麻婆豆腐', NULL, '经典川菜，麻辣鲜香',
     ...
     5, 15, 2, '{"川菜","麻辣","下饭"}', '烧', '麻辣', '荤', 'approved',
     '{"calories":420,"protein":22,"fat":28,"carbs":25,"per_serving":{"calories":420,"protein_g":22,"fat_g":28,"carbs_g":25,"fiber_g":4,"sodium_mg":900,"vitamin_c_mg":3},"ingredients_breakdown":[{"name":"嫩豆腐","calories":70,"protein_g":8,"fat_g":4,"carbs_g":3},{"name":"猪肉末","calories":150,"protein_g":12,"fat_g":10,"carbs_g":0},{"name":"豆瓣酱","calories":30,"protein_g":2,"fat_g":1,"carbs_g":4}],"health_notes":"含钠量较高，高血压患者请谨慎食用。"}'::jsonb),
    ...
    ('糖醋里脊', NULL, '外酥里嫩，酸甜开胃',
     ...
     20, 15, 3, '{"酸甜","下饭","宴客"}', '炸', '酸甜', '荤', 'approved',
     '{"calories":520,"protein":35,"fat":22,"carbs":45,"per_serving":{"calories":520,"protein_g":35,"fat_g":22,"carbs_g":45,"fiber_g":0,"sodium_mg":600,"vitamin_c_mg":1},"ingredients_breakdown":[{"name":"猪里脊","calories":300,"protein_g":27,"fat_g":10,"carbs_g":0},{"name":"鸡蛋","calories":70,"protein_g":6,"fat_g":5,"carbs_g":0},{"name":"淀粉","calories":80,"protein_g":0,"fat_g":0,"carbs_g":20}],"health_notes":"油炸食品，热量偏高，建议适量食用。"}'::jsonb),
    ...
    ('宫保鸡丁', NULL, '鸡丁嫩滑，花生酥脆',
     ...
     15, 10, 3, '{"川菜","麻辣","下饭"}', '炒', '麻辣', '荤', 'approved',
     '{"calories":380,"protein":30,"fat":18,"carbs":22,"per_serving":{"calories":380,"protein_g":30,"fat_g":18,"carbs_g":22,"fiber_g":2,"sodium_mg":750,"vitamin_c_mg":2},"ingredients_breakdown":[{"name":"鸡胸肉","calories":200,"protein_g":25,"fat_g":4,"carbs_g":0},{"name":"花生米","calories":110,"protein_g":5,"fat_g":8,"carbs_g":5},{"name":"干辣椒","calories":5,"protein_g":0.3,"fat_g":0.3,"carbs_g":1}],"health_notes":"含花生，过敏人群请注意。"}'::jsonb),
    ...
    ('清蒸鲈鱼', NULL, '原汁原味，鲜嫩不腥',
     ...
     5, 10, 3, '{"清淡","海鲜","宴客"}', '蒸', '清淡', '海鲜', 'approved',
     '{"calories":180,"protein":28,"fat":6,"carbs":2,"per_serving":{"calories":180,"protein_g":28,"fat_g":6,"carbs_g":2,"fiber_g":0,"sodium_mg":450,"vitamin_c_mg":2},"ingredients_breakdown":[{"name":"鲈鱼","calories":160,"protein_g":26,"fat_g":5,"carbs_g":0},{"name":"蒸鱼豉油","calories":10,"protein_g":1,"fat_g":0,"carbs_g":2}],"health_notes":"清淡低脂，富含优质蛋白，适合减脂期。"}'::jsonb),

    ('酸辣土豆丝', NULL, '爽脆开胃，简单快手',
     ...
     10, 8, 2, '{"酸辣","快手","家常"}', '炒', '酸辣', '素', 'approved',
    ...
    ('红烧肉', NULL, '肥而不腻，入口即化',
     ...
     15, 60, 4, '{"下饭","宴客","浓香"}', '炖', '酱香', '荤', 'approved',
     '{"calories":580,"protein":28,"fat":42,"carbs":18,"per_serving":{"calories":580,"protein_g":28,"fat_g":42,"carbs_g":18,"fiber_g":0,"sodium_mg":800,"vitamin_c_mg":0},"ingredients_breakdown":[{"name":"五花肉","calories":520,"protein_g":24,"fat_g":40,"carbs_g":0},{"name":"冰糖","calories":60,"protein_g":0,"fat_g":0,"carbs_g":16}],"health_notes":"热量和脂肪含量较高，高血脂人群请适量食用。"}'::jsonb),
    ...
    ('蒜蓉生菜', NULL, '脆嫩爽口，蒜香浓郁',
     ...
     5, 5, 2, '{"快手","素菜","低卡"}', '炒', '蒜香', '素', 'approved',
     '{"calories":60,"protein":3,"fat":2,"carbs":8,"per_serving":{"calories":60,"protein_g":3,"fat_g":2,"carbs_g":8,"fiber_g":2,"sodium_mg":350,"vitamin_c_mg":15},"ingredients_breakdown":[{"name":"生菜","calories":15,"protein_g":1.5,"fat_g":0.2,"carbs_g":3},{"name":"蚝油","calories":15,"protein_g":1,"fat_g":0.5,"carbs_g":3}],"health_notes":"低卡快手，适合减脂期食用。"}'::jsonb),
    ...
    ('回锅肉', NULL, '肥瘦相间，香辣下饭',
     ...
     15, 15, 3, '{"川菜","香辣","下饭"}', '炒', '香辣', '荤', 'approved',
     '{"calories":480,"protein":22,"fat":35,"carbs":12,"per_serving":{"calories":480,"protein_g":22,"fat_g":35,"carbs_g":12,"fiber_g":1,"sodium_mg":850,"vitamin_c_mg":5},"ingredients_breakdown":[{"name":"五花肉","calories":320,"protein_g":15,"fat_g":25,"carbs_g":0},{"name":"豆瓣酱","calories":30,"protein_g":2,"fat_g":1,"carbs_g":4}],"health_notes":"高脂高钠，建议搭配清淡蔬菜食用。"}'::jsonb),
    ...
    ('水煮鱼片', NULL, '鱼片嫩滑，麻辣鲜香',
     ...
     25, 20, 3, '{"川菜","麻辣","宴客"}', '煮', '麻辣', '海鲜', 'approved',
     '{"calories":350,"protein":32,"fat":18,"carbs":12,"per_serving":{"calories":350,"protein_g":32,"fat_g":18,"carbs_g":12,"fiber_g":2,"sodium_mg":950,"vitamin_c_mg":5},"ingredients_breakdown":[{"name":"草鱼","calories":180,"protein_g":28,"fat_g":6,"carbs_g":0},{"name":"豆芽","calories":15,"protein_g":1.5,"fat_g":0.2,"carbs_g":3},{"name":"豆瓣酱","calories":40,"protein_g":3,"fat_g":2,"carbs_g":5}],"health_notes":"麻辣高钠，高血压患者请谨慎食用。"}'::jsonb),
    ...
    ('蚝油牛肉', NULL, '滑嫩多汁，蚝香浓郁',
     ...
     15, 8, 2, '{"快手","鲜香","下饭"}', '炒', '鲜香', '荤', 'approved',
     '{"calories":250,"protein":26,"fat":12,"carbs":10,"per_serving":{"calories":250,"protein_g":26,"fat_g":12,"carbs_g":10,"fiber_g":1,"sodium_mg":500,"vitamin_c_mg":20},"ingredients_breakdown":[{"name":"牛肉","calories":200,"protein_g":22,"fat_g":10,"carbs_g":0},{"name":"蚝油","calories":15,"protein_g":1,"fat_g":0.5,"carbs_g":3}],"health_notes":"蚝油含钠，建议减少额外加盐。"}'::jsonb),
    ...
    ('醋溜白菜', NULL, '酸甜脆爽，简单快手',
     ...
     8, 8, 2, '{"酸甜","快手","家常"}', '炒', '酸甜', '素', 'approved',
     '{"calories":90,"protein":3,"fat":1,"carbs":18,"per_serving":{"calories":90,"protein_g":3,"fat_g":1,"carbs_g":18,"fiber_g":3,"sodium_mg":400,"vitamin_c_mg":25},"ingredients_breakdown":[{"name":"大白菜","calories":40,"protein_g":2,"fat_g":0.2,"carbs_g":8},{"name":"干辣椒","calories":3,"protein_g":0.2,"fat_g":0.2,"carbs_g":0.5}],"health_notes":"低卡低脂，开胃爽口。"}'::jsonb),

    ('干煸四季豆', NULL, '干香微辣，下饭神器',
     ...
     10, 15, 3, '{"干香","下饭","素菜"}', '煸', '干香', '素', 'approved',
     '{"calories":180,"protein":8,"fat":10,"carbs":18,"per_serving":{"calories":180,"protein_g":8,"fat_g":10,"carbs_g":18,"fiber_g":5,"sodium_mg":300,"vitamin_c_mg":10},"ingredients_breakdown":[{"name":"四季豆","calories":130,"protein_g":6,"fat_g":0.5,"carbs_g":16},{"name":"干辣椒","calories":3,"protein_g":0.2,"fat_g":0.2,"carbs_g":0.5}],"health_notes":"四季豆必须完全熟透，防止食物中毒。"}'::jsonb),
    ...
    ('葱爆羊肉', NULL, '羊肉嫩滑，葱香四溢',
     ...
     15, 8, 2, '{"快手","葱香","下饭"}', '爆', '葱香', '荤', 'approved',
     '{"calories":320,"protein":24,"fat":20,"carbs":8,"per_serving":{"calories":320,"protein_g":24,"fat_g":20,"carbs_g":8,"fiber_g":1,"sodium_mg":500,"vitamin_c_mg":3},"ingredients_breakdown":[{"name":"羊肉","calories":280,"protein_g":22,"fat_g":18,"carbs_g":0},{"name":"大葱","calories":15,"protein_g":0.5,"fat_g":0.2,"carbs_g":4}],"health_notes":"羊肉性温，适合冬季食用。"}'::jsonb),

    ('紫菜蛋花汤', NULL, '简单快手，鲜美暖胃',
     ...
     3, 5, 2, '{"清淡","快手","汤羹"}', '煮', '清淡', '素', 'approved',
     '{"calories":80,"protein":8,"fat":3,"carbs":5,"per_serving":{"calories":80,"protein_g":8,"fat_g":3,"carbs_g":5,"fiber_g":0,"sodium_mg":350,"vitamin_c_mg":2},"ingredients_breakdown":[{"name":"紫菜","calories":10,"protein_g":1.5,"fat_g":0.1,"carbs_g":1},{"name":"鸡蛋","calories":70,"protein_g":6,"fat_g":5,"carbs_g":0}],"health_notes":"清淡暖胃，适合饭后饮用。"}'::jsonb),
    ...
    ('鱼香肉丝', NULL, '酸甜带辣，经典川菜',
     ...
     15, 10, 3, '{"川菜","酸甜","下饭"}', '炒', '酸甜', '荤', 'approved',
     '{"calories":350,"protein":24,"fat":12,"carbs":35,"per_serving":{"calories":350,"protein_g":24,"fat_g":12,"carbs_g":35,"fiber_g":3,"sodium_mg":700,"vitamin_c_mg":5},"ingredients_breakdown":[{"name":"猪里脊","calories":200,"protein_g":18,"fat_g":6,"carbs_g":0},{"name":"木耳","calories":15,"protein_g":0.5,"fat_g":0.1,"carbs_g":4},{"name":"胡萝卜","calories":25,"protein_g":0.5,"fat_g":0.2,"carbs_g":6}],"health_notes":"鱼香口味含糖量较高，糖尿病患者留意。"}'::jsonb),

    ('西红柿炖牛腩', NULL, '汤汁浓郁，肉烂入味',
     ...
     15, 60, 4, '{"浓郁","下饭","宴客"}', '炖', '浓郁', '荤', 'approved',
     '{"calories":420,"protein":38,"fat":22,"carbs":16,"per_serving":{"calories":420,"protein_g":38,"fat_g":22,"carbs_g":16,"fiber_g":2,"sodium_mg":650,"vitamin_c_mg":20},"ingredients_breakdown":[{"name":"牛腩","calories":300,"protein_g":30,"fat_g":18,"carbs_g":0},{"name":"番茄","calories":40,"protein_g":2,"fat_g":0.5,"carbs_g":8},{"name":"洋葱","calories":15,"protein_g":0.5,"fat_g":0.1,"carbs_g":4}],"health_notes":"番茄红素丰富，牛肉补充铁质。"}'::jsonb),

    ('蒜蓉粉丝蒸虾', NULL, '粉丝吸汁，虾肉鲜甜',
     ...
     15, 10, 3, '{"蒜香","海鲜","宴客"}', '蒸', '蒜香', '海鲜', 'approved',
     '{"calories":220,"protein":24,"fat":8,"carbs":14,"per_serving":{"calories":220,"protein_g":24,"fat_g":8,"carbs_g":14,"fiber_g":0,"sodium_mg":550,"vitamin_c_mg":2},"ingredients_breakdown":[{"name":"大虾","calories":100,"protein_g":20,"fat_g":1.5,"carbs_g":0},{"name":"粉丝","calories":80,"protein_g":0.5,"fat_g":0,"carbs_g":18}],"health_notes":"虾肉高蛋白低脂肪，蒸制做法健康清淡。"}'::jsonb),
    ...
    ('地三鲜', NULL, '东北名菜，鲜香四溢',
     ...
     15, 15, 3, '{"东北菜","家常","素菜"}', '炒', '鲜香', '素', 'approved',
     '{"calories":200,"protein":5,"fat":8,"carbs":30,"per_serving":{"calories":200,"protein_g":5,"fat_g":8,"carbs_g":30,"fiber_g":4,"sodium_mg":400,"vitamin_c_mg":35},"ingredients_breakdown":[{"name":"土豆","calories":80,"protein_g":2,"fat_g":0.1,"carbs_g":18},{"name":"茄子","calories":40,"protein_g":1,"fat_g":0.2,"carbs_g":8},{"name":"青椒","calories":10,"protein_g":0.5,"fat_g":0.1,"carbs_g":2}],"health_notes":"蔬菜丰富，营养素均衡。"}'::jsonb),
    ...
    ('口水鸡', NULL, '鸡肉嫩滑，麻辣鲜香',
     ...
     15, 30, 2, '{"川菜","麻辣","凉菜"}', '拌', '麻辣', '荤', 'approved',
     '{"calories":380,"protein":26,"fat":24,"carbs":12,"per_serving":{"calories":380,"protein_g":26,"fat_g":24,"carbs_g":12,"fiber_g":1,"sodium_mg":780,"vitamin_c_mg":2},"ingredients_breakdown":[{"name":"鸡腿","calories":250,"protein_g":24,"fat_g":15,"carbs_g":0},{"name":"辣椒油","calories":60,"protein_g":0,"fat_g":7,"carbs_g":0},{"name":"花生碎","calories":25,"protein_g":2,"fat_g":2,"carbs_g":1}],"health_notes":"麻辣鲜香，含花生过敏原。"}'::jsonb),
    ...
    ('蛋炒饭', NULL, '粒粒分明，简单管饱',
     ...
     8, 8, 2, '{"快手","管饱","家常"}', '炒', '鲜香', '荤', 'approved',
     '{"calories":420,"protein":14,"fat":12,"carbs":60,"per_serving":{"calories":420,"protein_g":14,"fat_g":12,"carbs_g":60,"fiber_g":0,"sodium_mg":500,"vitamin_c_mg":1},"ingredients_breakdown":[{"name":"米饭","calories":350,"protein_g":7,"fat_g":1,"carbs_g":75},{"name":"鸡蛋","calories":70,"protein_g":6,"fat_g":5,"carbs_g":0}],"health_notes":"碳水化合物含量较高，适合运动后补充能量。"}'::jsonb)
) AS v(name, _unused_author_id, description, ingredients, instructions, steps,
       prep_time_minutes, cook_time_minutes, servings,
       tags, cooking_method, flavor, ingredient_type, status, nutrition_info)
WHERE NOT EXISTS (
    SELECT 1 FROM recipes r WHERE r.name = v.name
      AND r.author_id = (SELECT id FROM users WHERE username = 'testuser')
);
...
SELECT (SELECT id FROM users WHERE username = 'testuser'), v.*
FROM (VALUES
...
VALUES (
    (SELECT id FROM users WHERE username = 'testuser'), 175, 70, '["高血压"]'::jsonb
)
...
WHERE NOT EXISTS (
    SELECT 1 FROM favorite_groups fg
    WHERE fg.user_id = (SELECT id FROM users WHERE username = 'testuser')
      AND fg.name = v.name
);
...
SELECT u.id, r.id, fg.id, d.is_public
FROM (VALUES
    ('番茄炒蛋', '家常菜', TRUE),
    ('清炒西兰花', '低卡轻食', FALSE)
) AS d(recipe_name, group_name, is_public)
CROSS JOIN (SELECT id FROM users WHERE username = 'testuser') u
JOIN recipes r ON r.name = d.recipe_name AND r.author_id = (SELECT id FROM users WHERE username = 'testuser')
JOIN favorite_groups fg ON fg.name = d.group_name AND fg.user_id = u.id
WHERE NOT EXISTS (
...
SELECT u.id, r.id, d.rating, d.comment
FROM (VALUES
    ('番茄炒蛋', 5, '简单易做，味道好极了！')
) AS d(recipe_name, rating, comment)
CROSS JOIN (SELECT id FROM users WHERE username = 'testuser') u
JOIN recipes r ON r.name = d.recipe_name AND r.author_id = (SELECT id FROM users WHERE username = 'testuser')
WHERE NOT EXISTS (
    SELECT 1 FROM ratings rt WHERE rt.user_id = u.id AND rt.recipe_id = r.id
);

-- ====================================================================
-- 9. 系统公告（无外键，保持显式 id 以便管理端引用）
-- ====================================================================
...
WHERE NOT EXISTS (
    ...
    WHERE n.user_id = u.id AND n.title = d.title AND n.content = d.content
);
...
SELECT (SELECT id FROM users WHERE username = 'testuser'), '周末聚餐清单'
WHERE NOT EXISTS (
    SELECT 1 FROM shopping_lists sl
    WHERE sl.user_id = (SELECT id FROM users WHERE username = 'testuser')
      AND sl.name = '周末聚餐清单'
);
...
JOIN shopping_lists sl ON sl.name = '周末聚餐清单'
    AND sl.user_id = (SELECT id FROM users WHERE username = 'testuser')
WHERE NOT EXISTS (
    SELECT 1 FROM shopping_list_items sli
    WHERE sli.list_id = sl.id AND sli.ingredient_name = v.ingredient_name
);
...
SELECT u.id, r.id, d.date, d.meal_type
FROM (VALUES
    ('番茄炒蛋', '2026-05-13'::DATE, 'lunch'),
    ('清炒西兰花', '2026-05-13'::DATE, 'dinner')
) AS d(recipe_name, date, meal_type)
CROSS JOIN (SELECT id FROM users WHERE username = 'testuser') u
JOIN recipes r ON r.name = d.recipe_name AND r.author_id = (SELECT id FROM users WHERE username = 'testuser')
WHERE NOT EXISTS (
    SELECT 1 FROM meal_plans mp
    WHERE mp.user_id = u.id AND mp.recipe_id = r.id AND mp.date = d.date
);

-- ====================================================================
-- 14. 菜谱关联视频（通过菜名关联 recipe_id）
-- ====================================================================
INSERT INTO recipe_videos (recipe_id, title, platform, url, thumbnail_url, duration_seconds)
SELECT r.id, d.title, d.platform, d.url, d.thumbnail_url, d.duration_seconds
FROM (VALUES
    ('番茄炒蛋', '厨师长教你西红柿炒蛋的做法',         'youtube',  'https://www.youtube.com/watch?v=2hvQFxZBTVY', 'https://i.ytimg.com/vi/2hvQFxZBTVY/hqdefault.jpg', 503),
    ('番茄炒蛋', '番茄炒蛋零基础版',                   'bilibili', 'https://www.bilibili.com/video/BV1pD9MBfEwg', 'https://i0.hdslb.com/bfs/archive/a38d568dfac2d10187d2124f32de7dd6fdb922b3.jpg', 123),
    ('清炒西兰花', '西兰花的三种家常做法',               'youtube',  'https://www.youtube.com/watch?v=U_Xkq3Ots3w', 'https://i.ytimg.com/vi/U_Xkq3Ots3w/hqdefault.jpg', 540),
    ('鸡胸肉沙拉', '鸡肉沙拉超美味爽口做法',             'youtube',  'https://www.youtube.com/watch?v=6rm8jGYxIEw', 'https://i.ytimg.com/vi/6rm8jGYxIEw/hqdefault.jpg', 240),
    ('麻婆豆腐', '正宗麻婆豆腐高清重置版',             'youtube',  'https://www.youtube.com/watch?v=USoC8AqirVA', 'https://i.ytimg.com/vi/USoC8AqirVA/hqdefault.jpg', 640),
    ('麻婆豆腐', '家常小灶麻婆豆腐',                   'bilibili', 'https://www.bilibili.com/video/BV1jV41137Sy', 'https://i2.hdslb.com/bfs/archive/e82da03db145b57458ab6802e90cd06d892d5866.jpg', 280),
    ('糖醋里脊', '糖醋里脊老式经典做法',               'youtube',  'https://www.youtube.com/watch?v=vojPj5eS8uI', 'https://i.ytimg.com/vi/vojPj5eS8uI/hqdefault.jpg', 430),
    ('宫保鸡丁', '创新版宫保鸡丁',                     'youtube',  'https://www.youtube.com/watch?v=jArsVnwbLmc', 'https://i.ytimg.com/vi/jArsVnwbLmc/hqdefault.jpg', 440),
    ('清蒸鲈鱼', '清蒸鱼创新做法',                     'youtube',  'https://www.youtube.com/watch?v=XJ1YNbSU70w', 'https://i.ytimg.com/vi/XJ1YNbSU70w/hqdefault.jpg', 540),
    ('酸辣土豆丝', '炝炒酸辣土豆丝家常做法',             'youtube',  'https://www.youtube.com/watch?v=9HbErcNKAIk', 'https://i.ytimg.com/vi/9HbErcNKAIk/hqdefault.jpg', 540),
    ('红烧肉', '红烧肉的第二种做法肥而不腻',         'youtube',  'https://www.youtube.com/watch?v=cxRM-coyIA8', 'https://i.ytimg.com/vi/cxRM-coyIA8/hqdefault.jpg', 600),
    ('蒜蓉生菜', '蚝油生菜的家常做法',                 'youtube',  'https://www.youtube.com/watch?v=mIKFC54ZHzU', 'https://i.ytimg.com/vi/mIKFC54ZHzU/hqdefault.jpg', 300),
    ('回锅肉', '蒜苗回锅肉正宗做法',                 'youtube',  'https://www.youtube.com/watch?v=v72yoabCHXA', 'https://i.ytimg.com/vi/v72yoabCHXA/hqdefault.jpg', 540),
    ('水煮鱼片', '酸菜水煮鱼的家常做法',               'youtube',  'https://www.youtube.com/watch?v=tWzSkgE274o', 'https://i.ytimg.com/vi/tWzSkgE274o/hqdefault.jpg', 520),
    ('蚝油牛肉', '国宴大师蚝油牛肉',                   'youtube',  'https://www.youtube.com/watch?v=qPIsM0vfvDM', 'https://i.ytimg.com/vi/qPIsM0vfvDM/hqdefault.jpg', 360),
    ('醋溜白菜', '醋溜大白菜的家常做法',               'youtube',  'https://www.youtube.com/watch?v=jjyd_l0S85E', 'https://i.ytimg.com/vi/jjyd_l0S85E/hqdefault.jpg', 300),
    ('干煸四季豆', '干煸四季豆家常做法',                 'youtube',  'https://www.youtube.com/watch?v=4WU7xDeRZQc', 'https://i.ytimg.com/vi/4WU7xDeRZQc/hqdefault.jpg', 540),
    ('葱爆羊肉', '葱爆羊肉家常做法',                   'youtube',  'https://www.youtube.com/watch?v=BdTZURT3uL4', 'https://i.ytimg.com/vi/BdTZURT3uL4/hqdefault.jpg', 380),
    ('紫菜蛋花汤', '紫菜蛋花汤正确做法',                 'youtube',  'https://www.youtube.com/watch?v=tV-Pi10wBEk', 'https://i.ytimg.com/vi/tV-Pi10wBEk/hqdefault.jpg', 200),
    ('鱼香肉丝', '鱼香肉丝家常做法',                   'youtube',  'https://www.youtube.com/watch?v=wOtheXhqOAI', 'https://i.ytimg.com/vi/wOtheXhqOAI/hqdefault.jpg', 480),
    ('西红柿炖牛腩', '西红柿炖牛肉家常做法',               'youtube',  'https://www.youtube.com/watch?v=c7WdU8vyTTE', 'https://i.ytimg.com/vi/c7WdU8vyTTE/hqdefault.jpg', 540),
    ('蒜蓉粉丝蒸虾', '蒜蓉粉丝开背虾做法',                 'youtube',  'https://www.youtube.com/watch?v=o-I645If8rc', 'https://i.ytimg.com/vi/o-I645If8rc/hqdefault.jpg', 420),
    ('地三鲜', '地三鲜的简单做法',                   'youtube',  'https://www.youtube.com/watch?v=TKw5uYB1Vrw', 'https://i.ytimg.com/vi/TKw5uYB1Vrw/hqdefault.jpg', 360),
    ('口水鸡', '口水鸡的正宗做法',                   'youtube',  'https://www.youtube.com/watch?v=99nspRiav-A', 'https://i.ytimg.com/vi/99nspRiav-A/hqdefault.jpg', 540),
    ('蛋炒饭', '蛋炒饭的家常做法',                   'youtube',  'https://www.youtube.com/watch?v=EvE5cYNXufY', 'https://i.ytimg.com/vi/EvE5cYNXufY/hqdefault.jpg', 360)
) AS d(recipe_name, title, platform, url, thumbnail_url, duration_seconds)
JOIN recipes r ON r.name = d.recipe_name AND r.author_id = (SELECT id FROM users WHERE username = 'testuser')
WHERE NOT EXISTS (
